...
export const SelectField = ({ label, tooltip, error, ...props }: SelectFieldProps) => {
  ...
  return (
    <div className="flex flex-col gap-1.5 text-xs leading-[150%]">
      ...
      <select
        id={id}
        className="block appearance-none ps-3 pe-4 py-2.5 font-normal *:font-normal *:text-primary-60-green-04 text-primary-100-black rounded-lg border border-primary-10-green-05 bg-primary-100-white focus:outline focus:border-primary-10-green-05 focus:outline-primary-10-green-05"
        {...props}
      >
        <option value=""></option>
