    ...
    resources: {
      en: {
        translation: {
          ...
          environment_info:
            "You are using propably a non production deployment. Environment name:",
          error_api:
          ...
          error_openinghours:
            "The entered opening hours does not match the pattern needed.",
          ...
          submit: "Create",
          thanks:
            "Thank you for your support! The AED will appear in the next hours on the map.",
          title: "Report AED",
          try_again: "Try again",
        },
      },
      de: {
        translation: {
          ...
          error_location:
            "Der Standort wird benötigt, maximale Länge 200 Zeichen",
          error_openinghours:
          ...
          error_pos:
            "Die Position ist erforderlich. Wähle die Position auf der Karte aus.",
