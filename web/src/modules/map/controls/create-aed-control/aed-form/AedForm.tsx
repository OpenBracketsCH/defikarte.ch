...
export const AedForm = ({ map, form, setCreateMode, onSuccess }: AedFormProps) => {
  ...
  return (
    <div className="absolute z-10 h-auto md:h-[600px] lg:h-auto lg:w-[555px] rounded-2xl bottom-16 top-4 right-4 left-4 lg:bottom-6 md:top-6 md:right-6 md:left-6 lg:left-auto bg-primary-100-white shadow-custom-lg shadow-green-shadow-64">
